  ...
  "inline-flex items-center rounded-sm border px-2 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        soldout: "border-transparent bg-gray-100 text-gray-700",
        new: "border-transparent bg-green-50 text-secondary",
        popular: "border-transparent bg-orange-50 text-warning",
      },
    },
    defaultVariants: {
      variant: "default",
